...
public class SplineProceduralAnimation : MonoBehaviour
{
    ...
    private Vector3 Deform(Vector3 pos)
    {
        ...
        var forward = (curve.GetScaledPoint(forwardT, meshLength) - pivot) - curve.CachedForward(); // Forward -> Forward(A) = B - A
