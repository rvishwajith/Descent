...
namespace ProceduralAnimation
{
    public class Spline
    {
        ...
        public void Update()
        {
            p0 = transforms[0].position;
            p1 = transforms[1].position;
            p2 = transforms[2].position;
            p3 = transforms[3].position;
            parentDirection = parent.forward;
        }

        public Vector3 Point(float t)
        {
            return Utilities.Spline.Position(p0, p1, p2, p3, t);
        }
        ...
        {
            if (initialized)
                return Utilities.Spline.Length(p0, p1, p2, p3);
            else
                return 0;
        }
